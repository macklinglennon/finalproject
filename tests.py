...
def eq_float(e, a):
    ...
    Try typing this example into IDLE (adding 0.1 ten times):
...
poll_rows1 = [{"State":"WA", "Dem":"1.0", "Rep":"0.1", "Pollster":"A", "Date":"Jan 07 2010"},
              {"State":"WA", "Dem":"1.1", "Rep":"0.2", "Pollster":"B", "Date":"Mar 21 2010"},
              {"State":"WA", "Dem":"1.2", "Rep":"0.3", "Pollster":"A", "Date":"Jan 08 2010"},
              {"State":"OR", "Dem":"2.0", "Rep":"2.0", "Pollster":"A", "Date":"Feb 10 2010"},
              {"State":"WA", "Dem":"2.1", "Rep":"1.9", "Pollster":"B", "Date":"Feb 10 2010"},
              {"State":"WA", "Dem":"2.2", "Rep":"1.8", "Pollster":"B", "Date":"Mar 22 2010"}]

poll_rows2 = [{"State":"WA", "Dem":"0.3", "Rep":"4.0", "Pollster":"B", "Date":"Mar 21 2010"},
              {"State":"WA", "Dem":"0.5", "Rep":"6.0", "Pollster":"B", "Date":"Jan 07 2010"},
              {"State":"WA", "Dem":"0.7", "Rep":"7.0", "Pollster":"B", "Date":"Jan 08 2010"}]

def test_most_recent_poll_row():
    assert eq(most_recent_poll_row(poll_rows1, "A", "OR"), {"State":"OR", "Dem":"2.0", "Rep":"2.0", "Pollster":"A", "Date":"Feb 10 2010"})
    assert eq(most_recent_poll_row(poll_rows1, "A", "WA"), {"State":"WA", "Dem":"1.2", "Rep":"0.3", "Pollster":"A", "Date":"Jan 08 2010"})
    assert eq(most_recent_poll_row(poll_rows1, "B", "WA"), {"State":"WA", "Dem":"2.2", "Rep":"1.8", "Pollster":"B", "Date":"Mar 22 2010"})
    ...
    assert eq(most_recent_poll_row(poll_rows2, "B", "WA"), {"State":"WA", "Dem":"0.3", "Rep":"4.0", "Pollster":"B", "Date":"Mar 21 2010"})
...
def test_pollster_predictions():
    ...
    assert eq(pollster_predictions(rows3), {'PPP': {'WA': 0.9, 'CA': -1.1}, 'IPSOS': {'WA': 2.0, 'CA': -9.3}})
...
def test_average_error():
    ...
    state_edges_pred_5 = {'WA': 1.0}
    state_edges_act_5 = {'WA': -1.0}
    assert eq(average_error(state_edges_pred_5, state_edges_act_5), 2.0)    
...
def test_average_edge():
    ...
    assert eq(average_edge({"p1":1, "p2":2, "p3":3, "p4":4, "p5":5}, {"p1":1, "p2":2, "p3":3, "p4":4, "p5":5}), 1.560068324160182)
...
def test_predict_state_edges():
    ...
    assert eq(predict_state_edges(pollster_predictions, pollster_errors), 
              {'CA': -2.0908256880733944, 'FL': 0.5, 'ID': -0.6788990825688075, 'WA': -10.799509886766941})
